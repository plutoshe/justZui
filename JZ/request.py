...
params = urllib.urlencode({'location' : 1, "groupType": 2, "title" : "快下课", "content" : "测试2"})
...
#comment Like
# params = urllib.urlencode({'location' : 1, "groupType": 1, "title" : "快下课", "index" : 1})
# f = urllib.urlopen("http://localhost:1234/commentLike",params)
# print f.read()
# params = urllib.urlencode({'location' : 1, "groupType": 1, "title" : "快下课", "index" : 1})
# f = urllib.urlopen("http://localhost:1234/commentLike",params)
# print f.read()
# params = urllib.urlencode({'location' : 1, "groupType": 1, "title" : "快下课", "index" : 2})
# f = urllib.urlopen("http://localhost:1234/commentLike",params)
# print f.read()
# params = urllib.urlencode({'location' : 1, "groupType": 1, "title" : "快下课", "index" : 2})
# f = urllib.urlopen("http://localhost:1234/commentLike",params)
...
# f = urllib.urlopen("http://localhost:1234/commentLike",params)
# print f.read()
# params = urllib.urlencode({'location' : 1, "groupType": 1, "title" : "快下课", "index" : 3})
# f = urllib.urlopen("http://localhost:1234/commentLike",params)
# print f.read()
# params = urllib.urlencode({'location' : 1, "groupType": 1, "title" : "快下课", "index" : 4})
# f = urllib.urlopen("http://localhost:1234/commentLike",params)
# print f.read()
